    ...
    public class OrderItemsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.OrderItem != null ? 
                          ...
                          Problem("Entity set 'ApplicationDbContext.OrderItem'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,orderId,Name,Description,ImageUrl,Price,Amount")] OrderItem orderItem)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,orderId,Name,Description,ImageUrl,Price,Amount")] OrderItem orderItem)
        {
            if (id != orderItem.Id)
            {
                return NotFound();
